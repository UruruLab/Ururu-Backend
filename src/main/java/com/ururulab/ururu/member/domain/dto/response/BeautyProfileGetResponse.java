...
public record BeautyProfileGetResponse(
        Long id,
    ...
    public static BeautyProfileGetResponse from(final BeautyProfile beautyProfile) {
        return new BeautyProfileGetResponse(
                beautyProfile.getId(),
