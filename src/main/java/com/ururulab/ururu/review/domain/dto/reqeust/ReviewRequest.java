...
public record ReviewRequest(
		...
		@Min(value = ValidationConstants.RATING_MIN, message = ValidationMessages.RATING_MIN)
		@Max(value = ValidationConstants.RATING_MAX, message = ValidationMessages.RATING_MAX)
		Integer rating,
		...
		@Size(max = ValidationConstants.CONTENT_MAX_LENGTH, message = ValidationMessages.CONTENT_SIZE)
		String content,

		@Size(max = ValidationConstants.IMAGE_MAX_COUNT, message = ValidationMessages.IMAGE_SIZE)
