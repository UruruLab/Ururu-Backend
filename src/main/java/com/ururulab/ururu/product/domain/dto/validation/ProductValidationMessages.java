...
public class ProductValidationMessages {
    ...
    public static final String PRODUCT_DESCRIPTION_SIZE = "상품 설명은 " + PRODUCT_DESCRIPTION_MAX + "자를 초과할 수 없습니다";
    ...
    public static final String USAGE_SIZE = "사용방법은 " + USAGE_MAX + "자를 초과할 수 없습니다";
    ...
    public static final String CAUTION_SIZE = "주의사항은 " + CAUTION_MAX + "자를 초과할 수 없습니다";
